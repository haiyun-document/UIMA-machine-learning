...
try{
	    Vector td = new Vector();
     	System.out.println("********************************");
	    System.out.println("Check file: "+tfile+".tagged");
    	System.out.println("Check file: "+rfile+".raw");
       	System.out.println("********************************");
	    ...
	    int[] labels = null;
	    // read list of colu mns in the header of the tag file
	    ...
	    if (labels != null)
	{
		...
		if (fixedColFormat) {
		    ...
		    ptr = readRowVarCol(numLabels, tin, tagDelimit, delimit,impDelimit,t,cArray);// read colum
	...
	try {
	    ...
	    System.out.println("the file is in"+file+".tagged");
	    String line,rawLine;
	    rawLine=new String("");
